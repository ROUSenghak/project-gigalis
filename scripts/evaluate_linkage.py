...
def evaluate_benchmark(
    ...
    summary = {
        ...
        "caveats": {
            "label_source": (
                "Labels were generated by a single LLM research pass over real BOAMP "
                "notices, their official URLs, and wider public sources, dated "
                "2026-08-11, then spot-checked on a subset by the project owner. They "
                "are independent of every linkage method evaluated here, but they were "
                "not verified anchor-by-anchor, are not an independent human specialist "
                "panel, and are not legal renewal truth."
            ),
            "negative_definition": (
