...
def write_quality_markdown(
    ...
    path.write_text(
        ...
        "anchor-by-anchor. They are independent of the algorithms scored below, which "
        "the retired France-level reference was not, but they are neither an "
        "independent human specialist panel nor legal renewal truth.\n\n"
