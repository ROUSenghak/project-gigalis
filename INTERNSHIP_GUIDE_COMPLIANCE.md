...
| L4 Trend report | Ready with caveats | `TREND_ANALYSIS_REPORT.md`, notebook 14, quarterly counts, PELT sensitivity, ADF/KPSS stationarity, 3-state HMM regime model for Overall/CPV-72/CPV-32, signal matrix | No validated monetary series (no canonical awarded-amount field); breaks and regimes are statistical candidates, not stakeholder-confirmed causes |
